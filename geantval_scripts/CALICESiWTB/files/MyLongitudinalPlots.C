...
void DoLongitudinalPlots( const string physlist, const TString g4ver, int fileno, TString fullfilepath ) {
  ...
  TFile *inputFile;
      for (int file=fileno;file<fileno+1;file++)
        {
          int energy = (file+1)*2;
 ...
 //Data
  ...
  legendZ2->AddEntry(gZ_QGSP_BERT_2GeV,g4ver,"");
  legendZ2->Draw();
  text.DrawLatex(5.4,0.14,"#splitline{CALICESiWTB}{v0.4}");
  canvasZ2->SaveAs("2hits_longitudinal.pdf");
  ...
  legendZ4->AddEntry(gZ_QGSP_BERT_2GeV,g4ver,"");
  legendZ4->Draw();
  text.DrawLatex(3.9,0.14,"#splitline{CALICESiWTB}{v0.4}");
  canvasZ4->SaveAs("4hits_longitudinal.pdf");
  ...
  legendZ6->AddEntry(gZ_QGSP_BERT_2GeV,g4ver,"");
  legendZ6->Draw();
  text.DrawLatex(3.9,0.14,"#splitline{CALICESiWTB}{v0.4}");
  canvasZ6->SaveAs("6hits_longitudinal.pdf");
  ...
  legendZ8->AddEntry(gZ_QGSP_BERT_2GeV,g4ver,"");
  legendZ8->Draw();
  text.DrawLatex(3.9,0.14,"#splitline{CALICESiWTB}{v0.4}");
  canvasZ8->SaveAs("8hits_longitudinal.pdf");
  ...
  legendZ10->AddEntry(gZ_QGSP_BERT_2GeV,g4ver,"");
  legendZ10->Draw();
  text.DrawLatex(3.9,0.14,"#splitline{CALICESiWTB}{v0.4}");
  canvasZ10->SaveAs("10hits_longitudinal.pdf");
  ...
  ofstream myfile;
  myfile.open("2GeVenergy.txt");
  for (const auto &e : longitudinalProfile_QGSP_BERT_2GeV) myfile << e << " ";
  myfile.close();
  ...
  myfile.open("4GeVenergy.txt");
  for (const auto &e : longitudinalProfile_QGSP_BERT_4GeV) myfile << e << " ";
  myfile.close();
  ...
  myfile.open("6GeVenergy.txt");
  for (const auto &e : longitudinalProfile_QGSP_BERT_6GeV) myfile << e << " ";
  myfile.close();
  ...
  myfile.open("8GeVenergy.txt");
  for (const auto &e : longitudinalProfile_QGSP_BERT_8GeV) myfile << e << " ";
  myfile.close();
  ...
  myfile.open("10GeVenergy.txt");
  for (const auto &e : longitudinalProfile_QGSP_BERT_10GeV) myfile << e << " ";
  myfile.close();
  ...
  legendZ2->Draw();
  text.DrawLatex(9.4,49.3,"#splitline{CALICESiWTB}{v0.4}");
  ...
  legendZ8->Draw();
  text.DrawLatex(9.4,7.5,"#splitline{CALICESiWTB}{v0.4}");
