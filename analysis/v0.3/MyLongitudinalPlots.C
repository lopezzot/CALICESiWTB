...
void DoLongitudinalPlots( const string physlist, const TString g4ver ) {
  ...
  //
  filename[0] = "Data0p3_1/Calice_"+modelName+"_pi-_2GeV.root";
  filename[1] = "Data0p3_1/Calice_"+modelName+"_pi-_4GeV.root";
  filename[2] = "Data0p3_1/Calice_"+modelName+"_pi-_6GeV.root";
  filename[3] = "Data0p3_1/Calice_"+modelName+"_pi-_8GeV.root";
  filename[4] = "Data0p3_1/Calice_"+modelName+"_pi-_10GeV.root";
 ...
 //Data
  ...
  legendZ2->Draw();
  text.DrawLatex(5.4,0.14,"#splitline{CALICESiWTB}{v0p3}");
  ...
  legendZ4->Draw();
  text.DrawLatex(3.9,0.14,"#splitline{CALICESiWTB}{v0p3}");
